@description('Name of the Foundry (AI Services) resource.')
param name string
...
@description('Custom subdomain for the AI Services resource. Defaults to the resource name (must be globally unique).')
...
@description('Resource ID of the AI Services (Foundry) resource.')
...
@description('Principal ID of the resource managed identity.')
